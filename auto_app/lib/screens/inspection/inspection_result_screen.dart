                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              color: record.overallStatus.bgColor,
                          ...
                          Text(
                            '${fmt.format(record.date)} • ${record.mileage} км',
