        ...
        children: [
          ...
          Padding(
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                color: _inputError ? AppColors.danger.withOpacity(0.04) : AppColors.background,
              ...
              child: Row(
                children: [
                  Padding(
                    ...
                    child: Icon(
                      _inputError ? Icons.error_outline_rounded : Icons.edit_calendar_rounded,
                      size: 18,
                      color: _inputError ? AppColors.danger : AppColors.accent,
                    ),
                  ),
                  Expanded(
                    child: Focus(
                      onFocusChange: (gained) {
                        ...
                        if (!gained) {
                          ...
                          if (_inputCtrl.text.trim().isEmpty || _inputError) {
                            _inputCtrl.value = TextEditingValue(
                              text: _formatInput(),
                              selection: TextSelection.collapsed(offset: _formatInput().length),
                            );
                      ...
                      child: TextField(
                        ...
                        style: TextStyle(
                          ...
                          color: _inputError ? AppColors.danger : AppColors.textPrimary,
                          letterSpacing: 0.5,
                        ),
                        decoration: InputDecoration(
                          hintText: widget.withTime ? 'ЖЖЖЖ/СС/ӨӨ  ЦЦ:ММ' : 'ЖЖЖЖ/СС/ӨӨ',
                ...
                Expanded(
                  ...
                  child: SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: _inputError ? null : () => Navigator.pop(context, _result),
