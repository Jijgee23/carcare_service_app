...
extension CheckStatusExt on CheckStatus {
  String get label {
    switch (this) {
      case CheckStatus.good: return 'Хэвийн';
      case CheckStatus.warning: return 'Анхаарах';
      case CheckStatus.danger: return 'Засвар шаарддагатай';
    }
  }

  Color get color {
    switch (this) {
      case CheckStatus.good: return const Color(0xFF22C55E);
      case CheckStatus.warning: return const Color(0xFFF59E0B);
      case CheckStatus.danger: return const Color(0xFFEF4444);
    }
  }

  Color get bgColor {
    switch (this) {
      case CheckStatus.good: return const Color(0xFFDCFCE7);
      case CheckStatus.warning: return const Color(0xFFFEF3C7);
      case CheckStatus.danger: return const Color(0xFFFEE2E2);
    }
  }

  IconData get icon {
    switch (this) {
      case CheckStatus.good: return Icons.check_circle;
      case CheckStatus.warning: return Icons.warning_amber_rounded;
      case CheckStatus.danger: return Icons.cancel;
    }
  }
}
...
extension InspectionTypeExt on InspectionType {
  String get label {
    switch (this) {
      case InspectionType.technical: return 'Техникийн оношилгоо';
      case InspectionType.routine: return 'Ердийн үзлэг';
      case InspectionType.repair: return 'Засварын дараах';
    }
  }
}
...
class CheckItem {
  ...
  CheckItem({required this.id, required this.name, this.status = CheckStatus.good, this.note});

  CheckItem copyWith({CheckStatus? status, String? note}) =>
      CheckItem(id: id, name: name, status: status ?? this.status, note: note ?? this.note);
}
...
class InspectionSection {
  ...
  InspectionSection({required this.id, required this.title, required this.items});
...
class SampleData {
  static List<InspectionSection> get defaultSections => [
        InspectionSection(id: 'lights', title: 'Гэрэл, дохио', items: [
        ...
        InspectionSection(id: 'brake', title: 'Тормос', items: [
          ...
          CheckItem(id: 'brake_hose', name: 'Тормосны шингэн', status: CheckStatus.danger, note: 'Засвар шаарддагатай'),
        ...
        InspectionSection(id: 'chassis', title: 'Ходоо', items: [
  ...
  static List<InspectionRecord> get sampleRecords => [
        InspectionRecord(
          id: '1', date: DateTime(2024, 5, 20, 14, 30),
          plateNumber: 'УБ 1234 АБА', vehicleName: 'Toyota Prius 2016',
          type: InspectionType.technical, mileage: 125430, sections: defaultSections,
        ...
        InspectionRecord(
          id: '2', date: DateTime(2024, 5, 20, 11, 15),
          plateNumber: 'УБ 5678 СВА', vehicleName: 'Lexus RX350 2015',
          type: InspectionType.routine, mileage: 98200,
          sections: [InspectionSection(id: 'lights', title: 'Гэрэл, дохио', items: List.generate(8, (i) => CheckItem(id: 'l$i', name: 'Зүйл $i')))],
        ),
        InspectionRecord(
          id: '3', date: DateTime(2024, 5, 19, 16, 45),
          plateNumber: 'УБ 9012 DCD', vehicleName: 'Hyundai Sonata 2017',
          type: InspectionType.repair, mileage: 74500, sections: defaultSections,
          comment: 'Засвар хийгдсэн.',
        ),
        InspectionRecord(
          id: '4', date: DateTime(2024, 5, 19, 10, 30),
          plateNumber: 'УБ 3456 EFG', vehicleName: 'Kia Sorento 2014',
          type: InspectionType.technical, mileage: 112000, sections: defaultSections,
        ),
        InspectionRecord(
          id: '5', date: DateTime(2024, 5, 18, 15, 33),
          plateNumber: 'УБ 7890 HIJ', vehicleName: 'Nissan X-Trail 2016',
          type: InspectionType.routine, mileage: 89000, sections: defaultSections,
        ),
      ];
}
