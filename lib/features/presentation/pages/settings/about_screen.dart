...
class AboutScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: const Text('Тухай')),
      body: ListView(
        ...
        children: [
          ...
          Center(
            child: Container(
              ...
              child: const Icon(Icons.build_circle_rounded, color: Colors.white, size: 40),
            ),
          ),
          const SizedBox(height: 14),
          Center(child: Text('CarCare Ажилтан', style: AppTextStyles.h2)),
          const SizedBox(height: 4),
          Center(child: Text('Хувилбар 1.0.0 (1)', style: AppTextStyles.caption)),
          const SizedBox(height: 20),
          AppCard(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('Тухай', style: AppTextStyles.h3),
          ...
          Center(
            child: Text('© 2026 Инфосистемс ХХК', style: AppTextStyles.caption),
          ),
        ],
      ),
    );
