  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [IconButton(icon: const Icon(Icons.ios_share_outlined), onPressed: () {})],
      ),
      body: ListView(
              ...
              return Padding(
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Text(r, style: TextStyle(fontSize: 13, fontWeight: FontWeight.w600, color: active ? Colors.white : AppColors.textSecondary)),
                  ),
                ),
              );
            }).toList(),
          ...
          AppCard(
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Row(children: [
                ...
                Text('2024-05-14 – 2024-05-20', style: AppTextStyles.caption),
              ]),
              ...
              Row(children: [
                  ...
                  child: Stack(
                    ...
                    children: [
                      PieChart(PieChartData(
                        ...
                        sections: [
                          PieChartSectionData(color: AppColors.good, value: prov.totalGood.toDouble(), showTitle: false, radius: 28),
                          PieChartSectionData(color: AppColors.warning, value: prov.totalWarning.toDouble(), showTitle: false, radius: 28),
                          PieChartSectionData(color: AppColors.danger, value: prov.totalDanger.toDouble(), showTitle: false, radius: 28),
                        ],
                      )),
                ...
                Expanded(
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    _LegendRow(color: AppColors.good, label: 'Хэвийн', count: prov.totalGood, total: total),
                    const SizedBox(height: 10),
                    _LegendRow(color: AppColors.warning, label: 'Анхаарах', count: prov.totalWarning, total: total),
                    const SizedBox(height: 10),
                    _LegendRow(color: AppColors.danger, label: 'Засвар\nшаарддагатай', count: prov.totalDanger, total: total),
                  ]),
                ),
              ]),
            ]),
                ...
                child: BarChart(BarChartData(
                  ...
                  titlesData: FlTitlesData(
                    ...
                    bottomTitles: AxisTitles(sideTitles: SideTitles(
                      ...
                      getTitlesWidget: (value, _) {
                        ...
                        return Padding(padding: const EdgeInsets.only(top: 6), child: Text(keys[idx].substring(3), style: AppTextStyles.label.copyWith(fontSize: 10)));
                      },
                    )),
                    leftTitles: AxisTitles(sideTitles: SideTitles(
                      showTitles: true, interval: 5, reservedSize: 28,
                      getTitlesWidget: (v, _) => Text(v.toInt().toString(), style: AppTextStyles.label.copyWith(fontSize: 10)),
                    )),
                  ...
                  barGroups: List.generate(stats.length, (i) => BarChartGroupData(
                    ...
                    barRods: [BarChartRodData(
                      ...
                      color: AppColors.accent, width: 22,
