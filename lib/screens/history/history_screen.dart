...
class HistoryScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final tabColors = [AppColors.textSecondary, AppColors.good, AppColors.warning, AppColors.danger];
      ...
      body: Column(children: [
                  ...
                  child: GestureDetector(
                    ...
                    child: AnimatedContainer(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(color: isActive ? tabColors[i] : AppColors.divider, width: isActive ? 1.5 : 1),
                      ),
                      child: Text(tabs[i], style: TextStyle(fontSize: 13, fontWeight: isActive ? FontWeight.w600 : FontWeight.w400, color: isActive ? tabColors[i] : AppColors.textSecondary)),
                    ),
                  ),
                );
              }),
        ...
        Expanded(
          child: prov.filteredRecords.isEmpty
              ? const EmptyState(message: 'Бүртгэл олдсонгүй', icon: Icons.inventory_2_outlined)
              : ListView.builder(
                  ...
                  itemBuilder: (_, i) {
                    ...
                    return Padding(
                      ...
                      child: InspectionListCard(
                        record: record,
                        onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => InspectionResultScreen(record: record))),
                      ),
                    );
                  },
                ),
